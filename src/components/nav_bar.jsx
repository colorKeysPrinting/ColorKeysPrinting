    ...
    constructor(props){
        ...
        const items = [
            <a className='navItem'
                ...
                <Icons className="navIcon">phone</Icons> Call
            </a>,
            <Link className='navItem' activeClass="active" to="navigation" spy={true} smooth={true} offset={50} duration={500}
                ...
                <div className="navIcon"><Icons className="material-icons" style={{transform: 'rotate(50deg)'}}>navigation</Icons></div> Navigation
            </Link>,
            <Link className='navItem' activeClass="active" to="email" spy={true} smooth={true} offset={50} duration={500}
                ...
                <Icons className="navIcon">email</Icons> Email
            </Link>
        ]

        this.state = { scroll: animateScroll, Link, items, showNav: false };
