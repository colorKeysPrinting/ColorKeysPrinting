...
import { getProductById, updateProduct, createProduct, archiveProduct }      from 'ducks/products/actions';
...
class EditProduct extends React.Component {
    ...
    componentWillMount() {
        let { cookies, location } = this.props;
        ...
        if (location.state.product) {
            ...
            this.props.getProductById({ token: jwt.token, id: location });
