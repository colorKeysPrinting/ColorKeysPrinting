...
1. git clone https://bitbucket.org/HQ-Team/sibi_ge_admin my_project_name
...
an example "hello world" application in client/apps/sibi_ge_admin
...
file by setting `layout: custom_layout` in the front matter. See apps/sibi_ge_admin/html/about.md for an example.
