...
class HeaderBar extends React.Component {
    ...
    render() {
        ...
        if (!this.props.activeUserType || this.props.activeUserType === 'signUp') {
            ...
            const profilePic = (this.props.profilePic) ? assets(this.props.profilePic) : '';
        ...
        const to = (this.props.activeUserType && this.props.activeUserType !== 'signUp') ? `/products` : `/`;

        return (
            <div id="header-bar" style={styles.header}>
                <Tabs
                    type={this.props.activeUserType}
