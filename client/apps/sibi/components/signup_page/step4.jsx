...
export default function SignUpStep4(props) {
    ...
    const title = <div style={styles.titleBar}><div style={styles.title}>Billing info</div><div style={styles.steps}>step 4 of 4</div></div>;
    ...
    const content = (<form onSubmit={props.nextAction}>
        <div style={styles.content}>
            ...
            <div>
                ...
                <input type="text" placeholder="Street 2" value={props.str2}     onChange={(e) => props.update('str2', e.target.value)} />
                ...
                <input type="text" placeholder="Zipcode" value={props.cardZipcode} pattern="\d{5}-?(\d{4})?" onChange={(e) => props.update('cardZipcode', e.target.value)} required />
            </div>
        </div>
        <input className="submit-btn" type="submit" value="Finish" style={{ width: '89%' }} />
    </form>);
