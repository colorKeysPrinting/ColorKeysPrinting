...
export default function SignUpStep3(props) {
    ...
    const workerCompText = (props.docWorkerComp) ? (<div style={styles.added}>
        <div>
            <h2>Worker's comp</h2>
    ...
    const w9Text = (props.docW9) ? (<div style={styles.added}>
        <div>
            <h2>w9</h2>
    ...
    const insuranceText = (props.docInsurance) ? (<div style={styles.added}>
        <div>
    ...
    const goodmanText = (props.contractGoodman) ? (<div style={styles.added}>
        <div>
    ...
    const asureText = (props.contractAsure) ? (<div style={styles.added}>
        <div>
    ...
    const title = <div style={styles.titleBar}><div style={styles.title}>Compliance</div><div style={styles.steps}>step 3 of 4</div></div>;
    const content = (<form onSubmit={() => props.nextAction('step3')}>
